...
timesteps = 1
num_classes = 1
batch_size = 1 # dataScaledLog.shape[0]
...
model.add(LSTM(3, return_sequences=False))  # returns a sequence of vectors of dimension 32
...
model.fit(X_train, y_train,
          batch_size=batch_size, epochs=3, shuffle=True,
